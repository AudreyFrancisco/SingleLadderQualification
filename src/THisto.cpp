...
THisto::~THisto() {
  for (unsigned int j = 0; j < m_dim[1]; j++) {
    if (m_size == 1)
      delete[]((unsigned char **)m_histo)[j];
    if (m_size == 2)
      delete[]((unsigned short int **)m_histo)[j];
    if (m_size == 4)
      delete[]((float **)m_histo)[j];
    if (m_size == 8)
      delete[](double *)(m_histo[j]);
  }
  delete[] m_histo;
}
...
double THisto::operator()(unsigned int i) const {
  if (i < m_dim[0]) {
    if (m_size == 1)
      return (double)(((unsigned char **)m_histo)[0][i]);
    if (m_size == 2)
      return (double)(((unsigned short int **)m_histo)[0][i]);
    if (m_size == 4)
      return (double)(((float **)m_histo)[0][i]);
    if (m_size == 8)
      return (double)(((double **)m_histo)[0][i]);
  }
  return m_trash;
}
...
double THisto::operator()(unsigned int i, unsigned int j) const {
  if (i < m_dim[0] && j < m_dim[1]) {
    if (m_size == 1)
      return (double)(((unsigned char **)m_histo)[j][i]);
    if (m_size == 2)
      return (double)(((unsigned short int **)m_histo)[j][i]);
    if (m_size == 4)
      return (double)(((float **)m_histo)[j][i]);
    if (m_size == 8)
      return (double)(((double **)m_histo)[j][i]);
  }
  return m_trash;
}
...
void THisto::Set(unsigned int i, double val) {
  if (i < m_dim[0]) {
    if (m_size == 1)
      ((unsigned char **)m_histo)[0][i] = (unsigned char)val;
    if (m_size == 2)
      ((unsigned short int **)m_histo)[0][i] = (unsigned short int)val;
    if (m_size == 4)
      ((float **)m_histo)[0][i] = (float)val;
    if (m_size == 8)
      ((double **)m_histo)[0][i] = val;
  }
}
...
void THisto::Set(unsigned int i, unsigned int j, double val) {
  if (i < m_dim[0] && j < m_dim[1]) {
    if (m_size == 1)
      ((unsigned char **)m_histo)[j][i] = (unsigned char)val;
    if (m_size == 2)
      ((unsigned short int **)m_histo)[j][i] = (unsigned short int)val;
    if (m_size == 4)
      ((float **)m_histo)[j][i] = (float)val;
    if (m_size == 8)
      ((double **)m_histo)[j][i] = val;
  }
}
...
void THisto::Incr(unsigned int i) {
  ...
  if (i < m_dim[0]) {
    if (m_size == 1)
      ((unsigned char **)m_histo)[0][i]++;
    if (m_size == 2)
      ((unsigned short int **)m_histo)[0][i]++;
    if (m_size == 4)
      ((float **)m_histo)[0][i]++;
    if (m_size == 8)
      ((double **)m_histo)[0][i]++;
...
void THisto::Incr(unsigned int i, unsigned int j) {
  ...
  if (i < m_dim[0] && j < m_dim[1]) {
    ...
    if (m_size == 1)
      ((unsigned char **)m_histo)[j][i]++;
    if (m_size == 2)
      ((unsigned short int **)m_histo)[j][i]++;
    if (m_size == 4)
      ((float **)m_histo)[j][i]++;
    if (m_size == 8)
      ((double **)m_histo)[j][i]++;
