#ifndef BOARDCONFIGRUv1_H
#define BOARDCONFIGRUv1_H
...
class TBoardConfigRUv1 : public TBoardConfig {
public:
  TBoardConfigRUv1(const char *fName = 0, int boardIndex = 0);
