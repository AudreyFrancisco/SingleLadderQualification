...
public:
  ...
  ~TReadoutTest() {};
  int GetRow() {
    return ((TReadoutParameters *)m_parameters)->row;
  };
  int GetDriver() {
    return ((TReadoutParameters *)m_parameters)->driverStrength;
  };
  int GetLinkSpeed() {
    return ((TReadoutParameters *)m_parameters)->linkSpeed;
  };
  int GetPreemp() {
    return ((TReadoutParameters *)m_parameters)->preemp;
  };
  void Init();
