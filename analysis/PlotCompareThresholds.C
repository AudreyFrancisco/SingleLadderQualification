...
void fillData(int nPix, float *thr1, float *thr2, char *fileName1, char *fileName2, bool diff)
{ // Blatantly copied from test_ITHR
  int col1, row1, dc, adr, col2, row2,
      X; // only voltage+noise are used for now; the rest may be used later
