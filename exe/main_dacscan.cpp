                    ...
                    string suffix = "")
{
  ...
  std::cout << "ChipID = " << chip->GetConfig()->GetChipId() << "    Scanning DAC " << Name
            << std::endl;
  ...
  if (fBoards.size()) {
    ...
    for (unsigned int i = 0; i < fChips.size(); i++) {
      ...
      scanVoltageDac(fChips.at(i), Alpide::REG_VCASN, "VCASN", mySampleDist, mySampleRepetition,
                     Suffix);
      scanVoltageDac(fChips.at(i), Alpide::REG_VPULSEH, "VPULSEH", mySampleDist, mySampleRepetition,
                     Suffix);
      scanVoltageDac(fChips.at(i), Alpide::REG_VPULSEL, "VPULSEL", mySampleDist, mySampleRepetition,
                     Suffix);
      scanVoltageDac(fChips.at(i), Alpide::REG_VCASN2, "VCASN2", mySampleDist, mySampleRepetition,
                     Suffix);
      scanVoltageDac(fChips.at(i), Alpide::REG_VCLIP, "VCLIP", mySampleDist, mySampleRepetition,
                     Suffix);
      ...
      scanCurrentDac(fChips.at(i), Alpide::REG_IAUX2, "IAUX2", mySampleDist, mySampleRepetition,
                     Suffix);
      scanCurrentDac(fChips.at(i), Alpide::REG_IRESET, "IRESET", mySampleDist, mySampleRepetition,
                     Suffix);
