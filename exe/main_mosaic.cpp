...
int main(int argc, char **argv)
{
  ...
  // theBoardConfiguration = new TBoardConfigMOSAIC("Config.cfg", 0); // The file must exists... but
  ...
  theBoard = (TReadoutBoard *)new TReadoutBoardMOSAIC(
      config, (TBoardConfigMOSAIC *)config->GetBoardConfig(0));
