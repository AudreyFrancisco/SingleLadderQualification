...
void DisplayStatus(int numModules) {
  ...
  cout << "Back Bias   Voltage = " << thePowerBoard->GetBiasVoltage()
       << "    Current = " << thePowerBoard->GetBiasCurrent() << endl;
  ...
  for (int i = 0; i < numModules; i++) {
    ...
    cout << "    Analogic channel :  Voltage: " << AV << "   Current:" << AI
         << "    State =:" << (AChON ? "ON" : "off") << endl;
    cout << "    Digital channel :  Voltage: " << DV << "   Current:" << DI
         << "    State =:" << (DChON ? "ON" : "off") << endl;
  }
  cout << " ------------ " << endl;
  return;
}
...
void DoJob(int choice, int numModules) {
  ...
  case 2:
    ...
    scanf("%f", &AI);
    cout << endl << "Digital voltage :";
    scanf("%f", &DV);
    cout << endl << "Digital max current :";
    scanf("%f", &DI);
    cout << endl << "Back Bias [ON,OFF] :";
    scanf("%s", buf);
  ...
  case 5:
    ...
    break;
  case 6:
    cout << endl << "The Configuration File name to write :";
    scanf("%s", buf);
    theConfig = thePowerBoard->GetConfigurationHandler();
    theConfig->WriteToFile(buf);
    break;
  case 7:
    cout << endl << "The Configuration File name to read:";
    scanf("%s", buf);
    theConfig = thePowerBoard->GetConfigurationHandler();
