...
CLASS= TReadoutBoard.cpp TAlpide.cpp AlpideConfig.cpp AlpideDecoder.cpp USB.cpp USBHelpers.cpp TReadoutBoardDAQ.cpp TChipConfig.cpp TBoardConfigDAQ.cpp TConfig.cpp BoardDecoder.cpp
