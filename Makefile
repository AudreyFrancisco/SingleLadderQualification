...
CLASSES= TReadoutBoard.cpp TAlpide.cpp AlpideConfig.cpp AlpideDecoder.cpp AlpideDebug.cpp THIC.cpp USB.cpp USBHelpers.cpp TReadoutBoardDAQ.cpp \
 ...
 TScan.cpp TFifoTest.cpp TThresholdScan.cpp TDigitalScan.cpp TNoiseOccupancy.cpp TLocalBusTest.cpp TScanConfig.cpp TestBeamTools.cpp \
 TAnalogScan.cpp Common.cpp $(RU_SOURCES) $(MOSAIC_SOURCES)
